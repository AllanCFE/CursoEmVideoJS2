function contar (){
    ...
    else if(passo.value == 0 || passo.value < 0 && inicio.value < fim.value || passo.value > 0 && inicio.value > fim.value || inicio.value == fim.value || Math.abs(fim.value - inicio.value) < Math.abs(passo.value)) alert("Configuração inválida")
    else{
